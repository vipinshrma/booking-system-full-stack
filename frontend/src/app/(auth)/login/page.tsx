      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-md shadow-[0_10px_40px_rgba(31,41,55,0.05)] border-none">
        <div className="flex justify-between items-center h-20 px-6 md:px-12 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6">
            <Link
              href="/signup"
              className="bg-primary-container text-on-primary-container px-6 py-2.5 rounded-full font-sans text-sm font-semibold hover:opacity-90 active:scale-95 transition-all duration-300"
            >
              Join Now
            </Link>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center w-full">
            ...
            <div className="w-full lg:w-[420px] py-12">
              <div className="mb-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <h1 className="font-display text-3xl md:text-4xl font-bold text-on-surface mb-2">Welcome Back</h1>
                <p className="text-on-surface-variant font-sans text-sm">Experience your next journey with effortless luxury.</p>
              </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="space-y-1.5 text-left">
                  <div className="flex justify-between items-center px-1">
                    <Label className="font-sans text-xs font-semibold text-on-surface-variant" htmlFor="password">Password</Label>
                    <Link
                      href="/forgot"
                      className="text-primary font-sans text-xs font-semibold hover:underline cursor-pointer"
                    >
                      Forgot?
                    </Link>
                  </div>
                ...
                <div className="flex items-center gap-3 px-1">
                  ...
                  />
                  <Label className="font-sans text-sm text-on-surface-variant cursor-pointer select-none" htmlFor="remember">
